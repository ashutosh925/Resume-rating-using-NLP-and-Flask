...
class Resume:
    ...
    def parse(self):
        ...
        self.skill = TextPreprocessor().text_cleaning(text, '(.*)Skill')
        #print(self.skill)
...
class TextPreprocessor:
    ...
    # def getGitskills(self, url):
    #     url = 'https://chroniclesofelyria.com/domains/api/domain/3/1?parentIds%5B0%5D=22873'
    #
    #     return  git_skills_list;
...
if __name__ == '__main__':
    id_list = list()
    my_list = list()
    jobDescription = JobDescription('src/jobDescription1.txt')
    divide_obj = DividePaths('src/Resumes')
